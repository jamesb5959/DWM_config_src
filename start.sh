...
required_packages=("firefox" "discord" "xwallpaper" "nsxiv" "xorg-server" "xorg-xinit" "xorg-xsetroot" "picom" "vim" "git" "neofetch" "lightdm" "lightdm-gtk-greeter" "asusctl" "supergfxctl" "rog-control-center" "nvidia")
